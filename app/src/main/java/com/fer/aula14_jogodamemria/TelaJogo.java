...
public class TelaJogo extends AppCompatActivity {
   ...
   primeiro, segundo, clique1, clique2, imgNum = 1, turno = 1,
   ptsJ1 = 0, ptsJ2 = 0;
   Button btnVoltar;
   String j1, j2;
   ...
   private void clicarImagem(ImageView imagem) {
      imagem.setOnClickListener(new View.OnClickListener() {
         @Override
         public void onClick(View view) {
            int aux = Integer.parseInt((String) view.getTag());
            click.start();
            if(imagensVet[aux] == 101) imagem.setImageResource(dbz101);
            else if(imagensVet[aux] == 102) imagem.setImageResource(dbz102);
            else if(imagensVet[aux] == 103) imagem.setImageResource(dbz103);
            else if(imagensVet[aux] == 104) imagem.setImageResource(dbz104);
            else if(imagensVet[aux] == 105) imagem.setImageResource(dbz105);
            else if(imagensVet[aux] == 106) imagem.setImageResource(dbz106);
            else if(imagensVet[aux] == 107) imagem.setImageResource(dbz107);
            else if(imagensVet[aux] == 108) imagem.setImageResource(dbz108);
            else if(imagensVet[aux] == 201) imagem.setImageResource(dbz201);
            else if(imagensVet[aux] == 202) imagem.setImageResource(dbz202);
            else if(imagensVet[aux] == 203) imagem.setImageResource(dbz203);
            else if(imagensVet[aux] == 204) imagem.setImageResource(dbz204);
            else if(imagensVet[aux] == 205) imagem.setImageResource(dbz205);
            else if(imagensVet[aux] == 206) imagem.setImageResource(dbz206);
            else if(imagensVet[aux] == 207) imagem.setImageResource(dbz207);
            else if(imagensVet[aux] == 208) imagem.setImageResource(dbz208);
